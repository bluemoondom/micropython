...
if __name__=='__main__':
    ...
    while(True):
        ...
        s = (max_soil-soil.read_u16())*100/(max_soil-min_soil)
        hodnota1 = '1: {:.1f} %'.format(s)
        r = (max_rain-rain.read_u16())*100/(max_rain-min_rain)
        hodnota2 = '{:.1f} %'.format(r)
        #d.measure()
        #c = d.temperature()
        c = pinin2.read_u16()
        ...
        LCD.text("Dominika",80,25,LCD.white)
        
        LCD.fill_rect(0,40,240,40,LCD.blue)
        LCD.text("mon jardin",80,57,LCD.white)
        
        LCD.fill_rect(0,80,120,120,0x1805)
        LCD.text("pot de fleurs",15,100-3,LCD.white)
        #LCD.text("fleurs 1",20,120-3,LCD.white)
        LCD.text(hodnota1,15,120-3,LCD.white)
        ...
        LCD.text("Temperature:",15,140-3,LCD.white)
        hodnota3 = str(c) + " x"
        LCD.text(hodnota3,15,160-3,LCD.white)

        LCD.fill_rect(120,80,120,120,0xF073)
        LCD.text("cpt de pluie",125,100-3,LCD.white)
        LCD.text(hodnota2,125,120-3,LCD.white)
